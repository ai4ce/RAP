...
class UNet(nn.Module):
    def __init__(self, features_dim=32, backbone="resnet18", use_features_mask=False,
                 use_independent_mask_branch=False):
        super().__init__()
        ...
        if backbone == "resnet18":
            ...
            resnet = resnet34(weights=torchvision.models.ResNet34_Weights.DEFAULT)
        elif backbone == "resnet50":
            resnet = resnet50(weights=torchvision.models.ResNet50_Weights.DEFAULT)
        elif backbone == "resnet101":
            resnet = resnet101(weights=torchvision.models.ResNet101_Weights.DEFAULT)
        else:
